% ============== Comandos personales ==============
\newcommand{\bolacerrada}{\overline{B}}
\newcommand{\bolacerradaf}[3][]{\bolacerrada_{#1}(#2,\, #3)}
\newcommand{\bolacerradaunitariaf}[1][]{\bolacerrada_{#1}(0,\, 1)}

\newcommand{\bolaabierta}{B}
\newcommand{\bolaabiertaf}[3][]{\bolaabierta_{#1}(#2,\, #3)}
\newcommand{\bolaabiertaunitariaf}[1][]{\bolaabierta_{#1}(0,\, 1)}
...
%Comando para conjuntos
\newcommand{\conj}[1]{\left\{ #1 \right\}}
% Top. de la norma
\newcommand{\topDeLaNorma}{\TAU_{\norm{\bullet}}}

\newcommand{\dom}[1]{\cd({#1})}
\newcommand{\graf}[1]{\gr{(#1)}}
% norma
\newcommand{\norm}[2][]{{\parallel #2 \parallel}_{#1}}
% espacio de funciones
\newcommand{\Cf}[2][]{\mathcal{C}^{#1}(#2)}
% restringido a, obtenido de https://tex.stackexchange.com/questions/22252/how-to-typeset-function-restrictions
...
% Producto interno
\newcommand{\prodint}[3][]{ {\langle #2, \ #3 \rangle}_{#1} }
% def. funcion compleja
\newcommand{\deffunc}[5]{
\begin{array}{rcl}
...
% def. funcion simple
\newcommand{\deffuncs}[3]{#1: #2 \to #3}

% igual con definición arriba
...
% Ortogonal
\newcommand{\ort}{^{\perp}}
\newcommand{\ortc}[1]{{#1}^{\perp}}

% El generado
\newcommand{\gen}[2][N]{ < #2_1 ,\ \ldots ,\ #2_#1 > }
% conj de indices
\newcommand{\cind}[2][1]{ \{ #1 ,\ \ldots ,\ #2 \} }
\newcommand{\topdebil}[2]{\sigma(#1,\, #2)}
\newcommand{\topdebilE}{\topdebil{E}{E'}}
\newcommand{\topdebilestrE}{\topdebil{E'}{E}}
\newcommand{\topprod}{\TAU_{\text{prod}}}
\newcommand{\convdebil}{\rightharpoonup}
% adjunto
\newcommand{\adj}{^{*}}
\newcommand{\dadj}{^{**}}
\newcommand{\adjc}[1]{{#1}^{*}}
...
\newcommand{\contradic}{\begin{rotate}{25} \longrightarrow \longleftarrow \end{rotate}}

% TAU BKN
\newcommand{\TAU}[1][]{\mathcal{T}_{#1}}
% PHI para las funciones
\newcommand{\PHI}[1][]{\varphi_{#1}}
% ============== Comandos personales ==============
...
\newcommand{\p}{\partial}
\newcommand{\uno}[1]{\mathbf{1}_{#1}} % Indicatriz
\newcommand{\ep}{\varepsilon} % epsilon
\newcommand{\eps}{\varepsilon} % epsilon
\newcommand{\wt}{\widetilde} % Tilde (~)
\newcommand{\wh}{\widehat} % Gorrito (^)
\newcommand{\qand}{\quad\text{and}\quad} % and
\newcommand{\qqand}{\qquad\text{and}\qquad} % and
% \newcommand{\inv}[1]{\frac{1}{#1}} % inversa de
\newcommand{\abs}[1]{\ensuremath{\left|#1\right|}} % valor absoluto
\newcommand{\twopii}[1]{(2\pi\I)^{#1}} 
\newcommand{\itwopii}[1]{\frac{1}{(2\pi\I)^{#1}}}
\newcommand{\ord}[1]{O\left(#1\right)} % Orden de ( O(...) )
...
\DeclareMathOperator{\tr}{\mathop{\uptext{tr}}}
\DeclareMathOperator{\adh}{\mathop{\uptext{adh}}}
\DeclareMathOperator{\sgn}{\mathop{\uptext{sgn}}}
\DeclareMathOperator{\cod}{\mathop{\uptext{cod}}}
\DeclareMathOperator{\gr}{\mathop{\uptext{Gr}}}
\DeclareMathOperator{\codim}{\mathop{\uptext{codim}}}
\RedeclareMathOperator{\det}{\mathop{\uptext{det}}}
\RedeclareMathOperator{\ker}{\mathop{\uptext{ker}}}
\DeclareMathOperator{\im}{\mathop{\uptext{im}}}
...
% Formatting
% \definecolor{my_blue}{HTML}{d9e5ff}
% \definecolor{my_green}{HTML}{d4e9d7}
% \definecolor{my_red}{HTML}{e9d2d7}
% \usepackage[framemethod=TikZ]{mdframed}
% \mdfdefinestyle{st_red}{%
%     %linecolor=black,
%     %outerlinewidth=0pt,
%     roundcorner=3pt,
%     innertopmargin=8pt,
...
% \mdfdefinestyle{st_blue}{%
%     skipabove=-2pt,
%     style = st_red, 
%     innertopmargin=0pt,
%     backgroundcolor=my_blue}
% \mdfdefinestyle{st_green}{%
%     style = st_blue,
%     % innertopmargin=1pt,
%     backgroundcolor=my_green}
% \colorlet{Green}{green!90}

\newenvironment{sqgnote}{\begin{flushleft}\noindent\!\raisebox{0.25em}{\longsquiggly}\begin{minipage}[t]{0.9\textwidth}}{\end{minipage}\end{flushleft}}

% \newenvironment{thm}{\vs\begin{mdframed}[style=st_blue]\begin{teo}}{\end{teo}\end{mdframed}}
% \newenvironment{prop}{\vs\begin{mdframed}[style=st_blue]\begin{propo}}{\end{propo}\end{mdframed}}
% \newenvironment{defn}{\vs\begin{mdframed}[style=st_green]\begin{defin}}{\end{defin}\end{mdframed}}
% \newenvironment{exer}{\vs\begin{mdframed}[style=st_green]\begin{ejer}}{\end{ejer}\end{mdframed}}
% \newenvironment{rem}{\vs\begin{mdframed}[style=st_green]\begin{obs}}{\end{obs}\end{mdframed}}
...
\newcommand{\ucmark}{\tikz[y=0.80pt,x=0.80pt,yscale=-0.02,xscale=0.02, inner sep=0pt, outer sep=0pt]%
  {\path[fill=black,nonzero rule] (635.8833,600.0000) .. controls
